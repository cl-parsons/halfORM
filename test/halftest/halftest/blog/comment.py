...
"""The module halftest.blog.comment provides the Comment class.
...
@register
class Comment(MODEL.get_relation_class('blog.comment', fields_aliases=fields_aliases)):
    """
    DATABASE: halftest
    SCHEMA: blog
    TABLE: comment
    ...
    DESCRIPTION:
    The table blog.comment contains all the comments made by a person on a post.
    FIELDS:
    - id:        (int4) NOT NULL
    - content:   (text)
    - post_id:   (int4)
    - author_id: (int4)
    - column5:   (text) --- FIX ME! "a = 1" is not a valid identifier in Python.
    - tags:      (_text)
    ...
    def __init__(self, id: 'int'=None, content: 'str'=None, post_id: 'int'=None, author_id: 'int'=None, column5: 'str'=None, tags: 'typing.Any'=None, **kwargs):
        super().__init__(id=id, content=content, post_id=post_id, author_id=author_id, column5=column5, tags=tags, **kwargs)
